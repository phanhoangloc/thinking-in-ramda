...
Bài đăng này là Phần 4 của loạt bài về lập trình chức năng được gọi là Tư duy trong Ramda.



Trong Phần 3, chúng ta đã nói về việc kết hợp các chức năng có nhiều hơn một đối số bằng cách sử dụng các kỹ thuật ứng dụng một phần và currying.



Khi chúng tôi bắt đầu viết các khối xây dựng chức năng nhỏ và kết hợp chúng, chúng tôi phải viết rất nhiều chức năng bao gồm các toán tử của JavaScript như số học, so sánh, logic và luồng điều khiển. Điều này có thể cảm thấy buồn tẻ, nhưng Ramda đã trở lại của chúng tôi.



Nhưng trước tiên, một số nền.

## Bắt buộc và tuyên bố



Có nhiều cách khác nhau để phân chia các ngôn ngữ lập trình / phong cách phong cách. Có nhập tĩnh, gõ ngôn ngữ động, diễn dịch ngôn ngữ so với ngôn ngữ biên dịch, mức độ thấp so với cấp cao, v.v ...



Một bộ phận như vậy là lập trình bắt buộc với lập trình khai báo.



Nếu không đi quá sâu vào điều này, lập trình bắt buộc là một phong cách lập trình mà các lập trình viên nói với máy tính phải làm gì bằng cách nói cho nó làm thế nào để làm điều đó. Lập trình bắt buộc tạo ra rất nhiều cấu trúc mà chúng ta sử dụng hàng ngày: điều khiển luồng \(if-then-else statement và vòng lặp\), toán tử số học \(+, -, \*, /\), toán tử so sánh \(===,&gt;, &lt; , vv\), và các toán tử logic \(&&, \|\|,!\).
